          ...
          <nav className="flex items-center space-x-4">
            ...
            {!connectedAccount ? (
              <button 
                ...
                className="bg-white text-black px-4 py-2 rounded-full hover:bg-[#40E0D0] transition-colors flex items-center"
              >
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <button className="bg-[#40E0D0] text-black px-4 py-2 rounded-full hover:bg-[#40E0D0] transition-colors flex items-center">
                    <Wallet size={18} className="mr-2" />
