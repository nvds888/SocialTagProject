          ...
          >
            ...
            {!isVerified && (
              <motion.button 
                ...
                className={`max-w-full bg-transparent text-black px-6 py-3 rounded-lg text-lg font-semibold hover:bg-green-100 transition-colors relative overflow-hidden ${canVerify ? '' : 'opacity-50 cursor-not-allowed'}`}
