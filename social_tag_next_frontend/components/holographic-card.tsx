...
const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  return (
    <Card className="w-full max-w-md mx-auto bg-transparent rounded-3xl shadow-2xl overflow-hidden h-[600px] flex flex-col transform transition-all duration-300 hover:scale-105 relative holographic">
      <div className="absolute inset-0 z-0 bg-gradient-to-br from-purple-400 via-pink-500 to-red-500 opacity-30"></div>
      ...
      <CardContent className="p-6 flex flex-col h-full relative z-20">
        ...
        {email && (
          <Button
            variant="outline"
            className="w-full text-lg mb-6 bg-white/10 hover:bg-white/20 text-white border-white/20 transition-colors duration-300"
          >
            {email}
          </Button>
        )}
      ...
      <style jsx>{`
        .holographic {
          background: linear-gradient(45deg, #ff00cc, #3333ff, #00ff00, #ff00cc);
