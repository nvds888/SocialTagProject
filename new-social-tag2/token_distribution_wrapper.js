...
function initializeDistributionScheduler() {
    // Schedule to run at 11:27 AM UTC (12:27 PM GMT+1) daily
    console.log('Current time:', new Date().toISOString());
    const job = schedule.scheduleJob('27 11 * * *', () => {
    ...
    console.log('Token distribution scheduler initialized - will run daily at 12:27 PM GMT+1');
