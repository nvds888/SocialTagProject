...
function initializeDistributionScheduler() {
    // Schedule to run at 11:20 AM UTC (12:20 PM GMT+1) daily
    console.log('Current time:', new Date().toISOString());
    const job = schedule.scheduleJob('20 11 * * *', () => {
    ...
    console.log('Token distribution scheduler initialized - will run daily at 12:20 PM GMT+1');
